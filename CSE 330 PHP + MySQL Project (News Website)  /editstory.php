      ...
      while ($stmt->fetch()) {
          printf("
            <form method='POST' action='editstoryaction.php'>
              ...
              <input type='text' name='title_text' id='title_text_input' value='htmlentities($title)'>
              <label for='commentary_text'>Edit commentary:</label>
              <input type='text' name='commentary_text' id='commentary_text_input' value='htmlentities($commentary)'>
